...
A system that pulls data from Google Sheets to JSON files, then reads those files into Dictionaries for easy use.
I often use this for dialogue systems, since Sheets gives you a much better visual display for your script, plus
multi-user editing from any device, and then its only a couple clicks to pull that dialogue into the game.
